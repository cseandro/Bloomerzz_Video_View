...
public class bloomerzz_video_playerActivity extends Activity {
    bloomerzz_video_player player;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bloomerzz_video_player);
        ...
        if (config == null || TextUtils.isEmpty(config.url)) {
            ...
            player = new bloomerzz_video_player(this);
            ...
            player.setScaleType(TextUtils.isEmpty(config.scaleType) ? bloomerzz_video_player.SCALETYPE_FITPARENT : config.scaleType);
    ...
    public static void play(Activity context, String... url) {
        Intent intent = new Intent(context, bloomerzz_video_playerActivity.class);
    ...
    public static class Config implements Parcelable {
        ...
        public void play(String url) {
            this.url = url;
            Intent intent = new Intent(activity, bloomerzz_video_playerActivity.class);
