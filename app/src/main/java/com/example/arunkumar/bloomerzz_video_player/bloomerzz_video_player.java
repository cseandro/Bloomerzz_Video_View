package com.example.arunkumar.bloomerzz_video_player;
...
public class bloomerzz_video_player {
    /**
...
//                Toast.makeText(activity,"previous",Toast.LENGTH_LONG).show();
    ...
    private void updatePausePlay() {
        if (videoView.isPlaying()) {
            $.id(R.id.app_video_play).image(R.drawable.pause);
        } else {
            $.id(R.id.app_video_play).image(R.drawable.play);
        }
    }
    ...
    public bloomerzz_video_player(final Activity activity) {
        try {
...
//                        Toaster.show("download rate:" + extra);
    ...
    private void statusChange(int newStatus) {
        ...
        if (!isLive && newStatus==STATUS_COMPLETED) {
            ...
            hideAll();
            if (isLive) {
                showStatus(activity.getResources().getString(R.string.problem));
...
*/
    ...
    private void onVolumeSlide(float percent) {
        ...
        // 显示
        $.id(R.id.app_video_volume_icon).image(i==0?R.drawable.mute:R.drawable.volume_up);
        $.id(R.id.app_video_brightness_box).gone();
    ...
    private void updateFullScreenButton() {
        if (getScreenOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
            $.id(R.id.app_video_fullscreen).image(R.drawable.screen);
        } else {
            $.id(R.id.app_video_fullscreen).image(R.drawable.screen);
        }
    }
...
*/
     ...
     */
    public bloomerzz_video_player seekTo(int msec, boolean showControlPanle){
    ...
    public bloomerzz_video_player forward(float percent) {
    ...
    public bloomerzz_video_player playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public bloomerzz_video_player onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public bloomerzz_video_player onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public bloomerzz_video_player onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public bloomerzz_video_player onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public bloomerzz_video_player live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public bloomerzz_video_player toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public bloomerzz_video_player onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
